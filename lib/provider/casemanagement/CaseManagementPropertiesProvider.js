...
var ifPartProps = require('../cmmn/parts/IfPartProps'),
    ...
    processTaskProps = require('./parts/ProcessTaskProps'),
    onPartProps = require('../cmmn/parts/OnPartProps'),
    caseRolesProps = require('./parts/CaseplanModelProps');
...
function createGeneralTabGroups(element, cmmnFactory, elementRegistry, itemRegistry, cmmnRules) {
  ...
  processTaskProps(detailsGroup, element, cmmnFactory, elementRegistry, itemRegistry);
  callableProps(detailsGroup, element, cmmnFactory, elementRegistry, itemRegistry);
  caseRolesProps(detailsGroup, element, cmmnFactory, elementRegistry, itemRegistry);
...
function CasePropertiesProvider(eventBus, cmmnFactory, elementRegistry, itemRegistry, cmmnRules) {
...
inherits(CasePropertiesProvider, PropertiesActivator);

module.exports = CasePropertiesProvider;
